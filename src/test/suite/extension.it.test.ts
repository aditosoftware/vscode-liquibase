...
/**
 * Tests commands of the extension. This is more like an integration test.
 * If you want to write tests of the `extension.ts` file that does not execute any command, then use `extension.test.ts`.
 */
